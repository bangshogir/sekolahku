<x-slot name="page-title">Tentang Kami</x-slot>

<div class="animate-fade-in max-w-4xl mx-auto">
    {{-- Page Header --}}
    <div class="page-header">
        <div>
            <h1 class="page-title">Halaman Tentang Kami</h1>
            <p class="page-subtitle">Kelola informasi sejarah, profil, atau latar belakang madrasah</p>
        </div>
    </div>
    ...
    <form wire:submit="save">
        <div class="card p-5 shadow-sm space-y-5">
            ...
            <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <a href="{{ route('about') }}" target="_blank" class="text-sm font-medium text-green-600 hover:text-green-700 flex items-center gap-1">
                    Lihat Publikasinya
            ...
            {{-- Content (Quill) --}}
            <div>
                @error('aboutContent') <p class="form-error mb-2">{{ $message }}</p> @enderror
                    ...
                    x-data="{
                        ...
                        init() {
                            this.quill = new Quill(this.$refs.editor, {
                                theme: 'snow',
                                placeholder: 'Ketik latar belakang atau profil madrasah di sini...',
                                modules: {
                                    toolbar: [
                                        [{ header: [1, 2, 3, false] }],
                            ...
                            // Set initial content
                            this.quill.root.innerHTML = @js($aboutContent);

                            // Sync ke Livewire saat berubah
                            this.quill.on('text-change', () => {
                                $wire.set('aboutContent', this.quill.root.innerHTML);
                            });
                        }
                    }"
                >
